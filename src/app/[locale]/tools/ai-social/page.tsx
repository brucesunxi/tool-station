...
export default function SocialPage() {
  const t = useTranslations('tools.ai-social')
      ...
      <div className="bg-white dark:bg-gray-800 border rounded-xl p-6 mb-8">
        ...
        <div className="flex flex-wrap gap-4 mb-4">
          <select value={platform} onChange={e => setPlatform(e.target.value)} className="px-3 py-2 border rounded-lg text-sm dark:bg-gray-700 dark:border-gray-600">
            <option value="">{ct("anyPlatform")}</option>
            ...
            <option value="facebook">{ct("platformFacebook")}</option>
            <option value="tiktok">{ct("platformTiktok")}</option>
          </select>
        </div>
